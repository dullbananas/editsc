...
var $author$project$Ui$BodyText = function (a) {
	return {$: 'BodyText', a: a};
};
var $author$project$Ui$Col = function (a) {
	return {$: 'Col', a: a};
};
var $author$project$Ui$Text = function (a) {
	return {$: 'Text', a: a};
};
var $author$project$Ui$Url = function (a) {
	return {$: 'Url', a: a};
};
...
var $author$project$Ui$flatten = function (ui) {
	if (ui.$ === 'Col') {
		var items = ui.a;
		return $elm$core$List$concat(
			A2($elm$core$List$map, $author$project$Ui$flatten, items));
	} else {
		return _List_fromArray(
			[ui]);
	}
...
var $author$project$Ui$css = F2(
	function (name, value) {
		return $mdgriffith$elm_ui$Element$htmlAttribute(
			A2($elm$html$Html$Attributes$style, name, value));
	});
var $author$project$Ui$emSize = function (size) {
	return A2(
		$author$project$Ui$css,
		'font-size',
		$elm$core$String$fromFloat(size) + 'em');
};
...
var $author$project$Ui$bodyTextAttrs = _List_fromArray(
	[
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Font$typeface('Helvetiva'),
				$mdgriffith$elm_ui$Element$Font$sansSerif
			])),
		$author$project$Ui$emSize(0.75)
	]);
...
var $author$project$Ui$linkAttrs = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$Font$color(
		A3($mdgriffith$elm_ui$Element$rgb255, 0, 119, 255)),
...
var $author$project$Ui$bodyTextEl = function (textEl) {
	if (textEl.$ === 'Text') {
		var str = textEl.a;
...
var $author$project$Ui$toElement = function (ui) {
	if (ui.$ === 'Col') {
		var items = ui.a;
		return A2(
			...
			A2(
				$elm$core$List$map,
				$mdgriffith$elm_ui$Element$Lazy$lazy($author$project$Ui$toElement),
				items));
	} else {
		var textEls = ui.a;
		return A2(
			$mdgriffith$elm_ui$Element$paragraph,
			$author$project$Ui$bodyTextAttrs,
			A2(
				$elm$core$List$map,
				$mdgriffith$elm_ui$Element$Lazy$lazy($author$project$Ui$bodyTextEl),
				A2(
					$elm$core$Debug$log,
					'uh',
					A2(
...
var $author$project$Ui$wrapRootEl = $mdgriffith$elm_ui$Element$el(
	_List_fromArray(
		[
...
var $author$project$Ui$document = function (ui) {
	return {
		body: function () {
			var rootEl = $author$project$Ui$wrapRootEl(
				$author$project$Ui$toElement(
					$author$project$Ui$Col(
						$author$project$Ui$flatten(ui))));
...
var $author$project$Main$view = function (model) {
	return $author$project$Ui$document(
		$author$project$Ui$Col(
			_List_fromArray(
				[
					$author$project$Ui$BodyText(
					_List_fromArray(
						[
							$author$project$Ui$Text('Hello')
						])),
					$author$project$Ui$BodyText(
					_List_fromArray(
						[
							$author$project$Ui$Text('This is a'),
							$author$project$Ui$Text('link'),
							$author$project$Ui$Url('https://example.com')
						]))
				])));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))(0)}});}(this));// This is the beginning of the bundle file
"use-strict";
